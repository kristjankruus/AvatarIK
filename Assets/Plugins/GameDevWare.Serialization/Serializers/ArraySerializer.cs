...
namespace GameDevWare.Serialization.Serializers
{
	public sealed class ArraySerializer : TypeSerializer
	{
		...
		public ArraySerializer(Type enumerableType)
		{
			...
			else if (arrayType.IsInterface && arrayType.IsGenericType && (arrayType.GetGenericTypeDefinition() == typeof(IList<>) || arrayType.GetGenericTypeDefinition() == typeof(ICollection<>) || arrayType.GetGenericTypeDefinition() == typeof(IEnumerable<>)|| arrayType.IsGenericType))
