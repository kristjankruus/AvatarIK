    ...
    public sealed class SerializationContext
    {
        ...
        public TypeSerializer GetSerializerForType(Type valueType)
        {
            ...
            if (typeSerializerAttribute != null)
                ...
                serializer = this.CreateVector3Serializer(valueType);
            else if (typeof(Quaternion).IsAssignableFrom(valueType))
                serializer = this.CreateQuaternionSerializer(valueType);
            else
        ...
        private TypeSerializer CreateVector3Serializer(Type valueType)
        {
            return new Vector3Serializer();
        }
        private TypeSerializer CreateQuaternionSerializer(Type valueType)
        {
